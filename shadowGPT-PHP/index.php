...
$pageTitle = 'Zenith AI - Guide Personnel';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <title><?= $pageTitle ?? 'Zenith AI - Guide Personnel' ?> | <?= $monthNameFr ?> <?= $currentYear ?></title>
...
<div class="max-w-4xl mx-auto p-6" style="display: block !important; opacity: 1 !important;">
    ...
    <div class="gradient-bg text-white p-8 rounded-xl mb-8 text-center">
        <h1 class="text-4xl font-bold mb-4">🌟 Zenith AI - Guide Personnel</h1>
    ...
    <div class="mt-8 text-center text-gray-500 text-sm">
        ...
        <p class="mt-2">Zenith AI - Ton guide personnel vers la transformation</p>
    </div>
</div>
